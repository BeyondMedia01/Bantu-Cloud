...
const createPayslipSchema = z.object({
  ...
  grossZIG: z.number().optional(),
  payeUSD: z.number().optional(),
  payeZIG: z.number().optional(),
  aidsLevyUSD: z.number().optional(),
  aidsLevyZIG: z.number().optional(),
  nssaUSD: z.number().optional(),
  nssaZIG: z.number().optional(),
  netPayUSD: z.number().optional(),
  netPayZIG: z.number().optional(),
  exchangeRate: z.number().optional(),
  basicSalaryApplied: z.number().optional(),
});
  ...
  try {
    const payslip = await prisma.payslip.create({
      data: {
        ...
        netPay: body.netPay,
        ...(body.grossUSD !== undefined && { grossUSD: body.grossUSD }),
        ...(body.grossZIG !== undefined && { grossZIG: body.grossZIG }),
        ...(body.payeUSD !== undefined && { payeUSD: body.payeUSD }),
        ...(body.payeZIG !== undefined && { payeZIG: body.payeZIG }),
        ...(body.aidsLevyUSD !== undefined && { aidsLevyUSD: body.aidsLevyUSD }),
        ...(body.aidsLevyZIG !== undefined && { aidsLevyZIG: body.aidsLevyZIG }),
        ...(body.nssaUSD !== undefined && { nssaUSD: body.nssaUSD }),
        ...(body.nssaZIG !== undefined && { nssaZIG: body.nssaZIG }),
        ...(body.netPayUSD !== undefined && { netPayUSD: body.netPayUSD }),
        ...(body.netPayZIG !== undefined && { netPayZIG: body.netPayZIG }),
        ...(body.exchangeRate !== undefined && { exchangeRate: body.exchangeRate }),
        ...(body.basicSalaryApplied !== undefined && { basicSalaryApplied: body.basicSalaryApplied }),
      },
      include: {
