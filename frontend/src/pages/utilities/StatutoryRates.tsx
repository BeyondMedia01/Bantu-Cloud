    ...
    <div className="max-w-2xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500 font-medium text-sm">Configure global default rates for SDF and ZIMDEF</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="bg-primary rounded-2xl border border-border p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold text-sm uppercase tracking-wider text-slate-400">Employer Contributions</h3>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">Standards Development Fund (default: 0.5%)</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">Zimbabwe Manpower Development Fund (default: 1.0%)</p>
                </div>
              </div>
            </div>
