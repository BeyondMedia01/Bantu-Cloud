    ...
    <div className="flex flex-col gap-8">
      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground font-medium">Monthly aggregation of employee earnings, deductions, and net pay ledgers.</p>
        </div>
        <div className="flex items-center gap-3">
           <button className="bg-muted text-navy px-6 py-3 rounded-[9999px] font-bold hover:bg-muted transition-colors flex items-center gap-2">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider">{new Date(s.payPeriod).toLocaleDateString(undefined, { month: 'long', year: 'numeric' })}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      ...
                      {!s.isFinalized && (
                        <button 
                          ...
                          className="p-2 hover:bg-emerald-50 rounded-lg text-muted-foreground hover:text-accent-green transition-colors"
                        >
                          <CheckCircle size={16} />
                        </button>
                      )}
