...
const ClientSettings: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-8 max-w-4xl">
      ...
      <section>
        <h2 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-4">Platform Preferences</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-primary border border-border rounded-2xl p-5 shadow-sm">
            ...
            <div className="flex p-1 bg-muted dark:bg-slate-800 rounded-xl gap-1">
          ...
          <div className="bg-primary border border-border rounded-2xl p-5 shadow-sm">
            ...
            <Dropdown className="w-full" trigger={(isOpen) => (
              <button type="button" className="w-full flex items-center justify-between px-3 py-2 bg-muted rounded-xl text-xs font-bold hover:bg-muted transition-colors">
      ...
      {SETTINGS_SECTIONS.map((section) => (
        <div key={section.title}>
          <h2 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-4">{section.title}</h2>
          <div className="flex flex-col divide-y divide-border bg-primary border border-border rounded-2xl shadow-sm overflow-hidden">
            {section.items.map((item) => (
              <button
                ...
                className="p-5 hover:bg-muted transition-colors text-left flex items-center gap-4"
              >
