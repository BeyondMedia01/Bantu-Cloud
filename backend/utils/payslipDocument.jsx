...
const s = StyleSheet.create({
  ...
  rowUnits:    { width: 38, fontSize: 7.5, textAlign: 'right', color: TEXT_MUTED,
                 fontFamily: 'Helvetica', lineHeight: 1.2 },
  ...
  rowYtd:      { width: 52, fontFamily: 'Helvetica', fontSize: 7, textAlign: 'right',
  ...
  empRowYtd:   { width: 58, fontFamily: 'Helvetica', fontSize: 7, textAlign: 'right',
                 color: TEXT_MUTED, lineHeight: 1.2 },
